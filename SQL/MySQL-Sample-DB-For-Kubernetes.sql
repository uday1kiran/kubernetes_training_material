...
docker run --rm -dit -v testvol3:/var/lib/mysql --name mysql mysql/mysql-server:latest
docker logs mysql #For Default Password
ALTER USER 'root'@'localhost' IDENTIFIED  BY 'India12345';
